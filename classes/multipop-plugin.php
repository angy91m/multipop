...
class MultipopPlugin {
    ...
    public function admin_init() {
        ...
        if (count($current_user->roles) == 1 && in_array($current_user->roles[0], ['multipopolano','multipopolare_resp','multipopolare_friend']) && !get_user_meta( $user->ID, '_edit_mpop_events', true )) {
