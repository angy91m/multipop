import { mergeModels as i2, useModel as T2, ref as I1, onMounted as N2, watch as A2, onUnmounted as E2, withDirectives as D2, openBlock as M2, createElementBlock as P2, mergeProps as x2, vModelText as R2 } from '/wp-content/plugins/multipop/js/vue.esm-browser.js';
const n2 = [
  [
    "af",
    // Afghanistan
...
const B2 = {
  ...
  selectedCountryAriaLabel: "Nazione selezionata",
  noCountrySelected: "Nessuna nazione selezionata",
  countryListAriaLabel: "Lista nazioni",
  searchPlaceholder: "Cerca",
  zeroSearchResults: "Nessun risultato",
  oneSearchResult: "1 risultato",
  multipleSearchResults: "${count} resultati",
