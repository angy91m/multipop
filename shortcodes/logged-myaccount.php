        ...
        <q-page-container>
            ...
            <div v-if="selectedTab.name == 'moduleUpload' && moduleUploadData.sub">
                ...
                >
                    ...
                    >
                        <mpop-uploader id="prova-upload" v-model="moduleUploadData.signedModuleFiles" :binary="true" :formatter="v => {const f = {content: v.content, type: v.meta.type}; return f;}" @change="consoleLog(moduleUploadData.signedModuleFiles)">Carica</mpop-uploader>
                    </q-step>
                    <q-step
                        :name="2"
