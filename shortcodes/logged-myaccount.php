            ...
            <div v-if="selectedTab.name == 'moduleUpload' && moduleUploadData.sub">
                ...
                >
                    ...
                    >
                        ...
                        <br><br><button :disabled="moduleUploadData.withSignature ? !isValidSignature : !moduleUploadData.signedModuleFiles.length" @click="()=>moduleUploadData.step+= (isValidIdCard ? 2 : 1)">Avanti</button>
                    </q-step>
                    <q-step
                        v-if="!isValidIdCard"
                        :name="2"
