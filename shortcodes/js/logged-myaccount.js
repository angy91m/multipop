...
createApp({
    ...
    setup() {
        ...
        otherSubscriptions = computed(() => {const a = (profile.mpop_my_subscritions || []).filter(c => nearActiveSub.value ? nearActiveSub.value.id !== c.id : true); console.log(a);console.log(profile); return a;}),
