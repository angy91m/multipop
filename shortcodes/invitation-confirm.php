...
<div id="app" class="mpop-form">
    ...
    <p class="mpop-form-row">
        <input type="date"
            :class="savingErrors.includes('mpop_birthdate') ? 'bad-input' : ''"
    ...
    <p class="mpop-form-row">
        <v-select
            ...
            :class="savingErrors.includes('mpop_birthplace') ? 'bad-input' : ''"
    ...
    <p class="mpop-form-row">
        <v-select
            ...
            :class="savingErrors.includes('mpop_billing_city') ? 'bad-input' : ''"
    ...
    <p class="mpop-form-row">
        <select v-model="user.mpop_billing_state" :class="savingErrors.includes('mpop_billing_state') ? 'bad-input' : ''" disabled>
            <option
    ...
    <p class="mpop-form-row">
        <select v-model="user.mpop_billing_zip" :class="savingErrors.includes('mpop_billing_zip') ? 'bad-input' : ''" :disabled="!user.mpop_billing_city || user.mpop_billing_city.cap.length == 1">
    ...
    <p class="mpop-form-row">
        <textarea v-model="user.mpop_billing_address" :class="savingErrors.includes('mpop_billing_address') ? 'bad-input' : ''" :disabled="!user.mpop_billing_zip"></textarea>
    </p>
    <p class="mpop-form-row">
        <v-intl-phone
            ref="phoneInput"
            ...
            value=""
            :class="savingErrors.includes('mpop_phone') ? 'bad-input' : ''"
