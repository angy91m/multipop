...
switch( $post_data['action'] ) {
    case 'admin_search_users':
        [$users, $total, $limit] = $this->user_search($post_data['txt'], $post_data['roles'], $post_data['mpop_billing_state'], $post_data['mpop_billing_city'], $post_data['mpop_resp_zones'], $post_data['mpop_card_active'], $post_data['page'], $post_data['sortBy']);
